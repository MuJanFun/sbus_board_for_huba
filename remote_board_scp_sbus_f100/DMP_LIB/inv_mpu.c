...
#include "inv_mpu.h"
#include "stm32f10x.h"
#include "bsp/ano_tech_stm32f10x_i2c.h"
#include "Time.h"
#include "bsp/usart.h"
...
#define log_e    Uart1_Put_String
#define log_i    Uart1_Put_String
...
{
	if(len==1)	ANO_Tech_I2C1_Write_1Byte(addr,reg,*data);
	else				ANO_Tech_I2C1_Write_Buf(addr,reg,len,data);
	return 0;
}
int8_t i2cread(uint8_t addr, uint8_t reg, uint8_t len, uint8_t *buf)
{
	ANO_Tech_I2C1_Read_Buf(addr,reg,len,buf);
	return 0;
}
static int set_int_enable(unsigned char enable)
{
