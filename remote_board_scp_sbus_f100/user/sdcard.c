...
//    }
    ...
    else if(r1 == 0x01)
    {
        ...
        buffa[0] = SPI_ReadWriteByte(0xFF);  //should be 0x00
        buffa[1] = SPI_ReadWriteByte(0xFF);  //should be 0x00
        buffa[2] = SPI_ReadWriteByte(0xFF);  //should be 0x01
        buffa[3] = SPI_ReadWriteByte(0xFF);  //should be 0xAA
        ...
        if(buffa[2]==0x01 && buffa[3]==0xAA)
        {
            ...
            buffa[0] = SPI_ReadWriteByte(0xFF);
            buffa[1] = SPI_ReadWriteByte(0xFF); 
            buffa[2] = SPI_ReadWriteByte(0xFF);
            buffa[3] = SPI_ReadWriteByte(0xFF);
